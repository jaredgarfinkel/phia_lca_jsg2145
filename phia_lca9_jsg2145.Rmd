...
simpler_vl2_conmat_df$class = factor(simpler_vl2_conmat_df$class, levels = c("aware on art" = 1, "never tested" = 2, "aware not on art" = 3, "reported negative" = 4), labels = c("aware", "unaware", "aware", "unaware"))
...
simpler_vl2_conmat_df$class = factor(simpler_vl2_conmat_df$class, levels = c("aware on art" = 1, "never tested" = 2, "aware not on art" = 3, "reported negative" = 4), labels = c("on art", "not on art", "not on art", "not on art"))
...
full_dat_out4_conmat_df$class = factor(full_dat_out4_conmat_df$class, levels = c("aware not on art" = 1, "aware on art" = 2, "never tested" = 3, "reported negative" = 4), labels = c("aware", "aware", "unaware", "unaware"))
...
full_dat_out4_conmat_df$class = factor(full_dat_out4_conmat_df$class, levels = c("aware not on art" = 1, "aware on art" = 2, "never tested" = 3, "reported negative" = 4), labels = c("not on art", "on art", "not on art", "not on art"))
