...
simpler_arv_conmat_df$class = factor(simpler_arv_conmat_df$class, levels = c("reported negative" = 1, "never tested" = 2, "aware not on art" = 3, "aware on art" = 4), labels = c("on art", "not on art", "not on art", "not on art"))
...
simpler_arv_conmat_df$class = factor(simpler_arv_conmat_df$class, levels = c("reported negative" = 1, "never tested" = 2, "aware not on art" = 3, "aware on art" = 4), labels = c("aware", "unaware", "unaware", "aware"))
