...
```{r pROC, include = FALSE, eval = FALSE}
roc(bio_dat$tri90aware, c(bio_dat$awareselfreported, bio_dat$arvstatus, bio_dat$vlunder200), levels = c("aware", "unaware"), data = bio_dat)
