...
x <- drive_get("https://drive.google.com/file/d/1FtvuLal09-fpY0awf759dCSoimueItKF/view?usp=sharing")

x$id

drive_download(file = x, path = "./data/Shims22016adultbio.csv", overwrite = TRUE)

bio <- import("G:\\My Drive\\PHIA Data Collaboration\\Data\\Public Release\\Eswatini\\shims22016adultbio.sas7bdat")
ind <- import("G:\\My Drive\\PHIA Data Collaboration\\Data\\Public Release\\Eswatini\\shims22016adultind.sas7bdat")
```
...
model <- jags.model("xiamodel.bug", data = model.data, n.chains = 4)
...
out <- run.jags(model="xiamodel.bug", monitor=monitors,
...
model.vl <- jags.model("xiamodel.bug", data = model.data.vl, n.chains = 2)
...
multicountry.data <- import("multicountry_model_out_2.xlsx")
